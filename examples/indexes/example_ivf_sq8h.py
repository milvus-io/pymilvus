...
if __name__ == '__main__':
    collection_name = "milvus_demo_ivf_sq8h"
    ...
    # create `IVF_SQ8H` index
    status = client.create_index(collection_name, IndexType.IVF_SQ8H, index_param)
    if status.OK():
        print("Create index IVF_SQ8H successfully\n")
    else:
