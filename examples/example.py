...
# ------
# Basic insert entities:
#     Each item in `bulk_entities` represents a field, and must contains keys 'name' and 'values'.
#     It is allowed but not necessary to specify type of field by adding key 'type' in each item,
#     for example:
