...
class TestAsyncConnectionReuse:
    def test_async_client_alias_different_loops(self):
        ...
        async def create_client():
            ...
            with patch("pymilvus.orm.connections.Connections.connect"), patch(
        ...
        try:
            ...
            LOGGER.info(f"Loop 1 ID: {loop1_id}, Alias 1: {alias1}")
            LOGGER.info(f"Loop 2 ID: {loop2_id}, Alias 2: {alias2}")
