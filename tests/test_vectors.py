...
class TestGetVectorByID:
    ...
    def test_get_vectors_by_ids_invalid_id(self, v_id, gcon):
        with pytest.raises(ParamError):
            gcon.get_vectors_by_ids("test_get_vectors_by_ids_invalid_id", [v_id])
