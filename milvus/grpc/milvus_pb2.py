...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0cmilvus.proto\x12\x0bmilvus.grpc\x1a\x0cstatus.proto\"?\n\tTableName\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.milvus.Status\x12\x12\n\ntable_name\x18\x02 \x01(\t\"z\n\x0bTableSchema\x12*\n\ntable_name\x18\x01 \x01(\x0b\x32\x16.milvus.grpc.TableName\x12\x12\n\nindex_type\x18\x02 \x01(\x05\x12\x11\n\tdimension\x18\x03 \x01(\x03\x12\x18\n\x10store_raw_vector\x18\x04 \x01(\x08\"/\n\x05Range\x12\x13\n\x0bstart_value\x18\x01 \x01(\t\x12\x11\n\tend_value\x18\x02 \x01(\t\" \n\tRowRecord\x12\x13\n\x0bvector_data\x18\x01 \x03(\x02\"S\n\x0bInsertInfos\x12\x12\n\ntable_name\x18\x01 \x01(\t\x12\x30\n\x10row_record_array\x18\x02 \x03(\x0b\x32\x16.milvus.grpc.RowRecord\"D\n\tVectorIds\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.milvus.Status\x12\x17\n\x0fvector_id_array\x18\x02 \x03(\x03\"\x98\x01\n\x11SearchVectorInfos\x12\x12\n\ntable_name\x18\x01 \x01(\t\x12\x32\n\x12query_record_array\x18\x02 \x03(\x0b\x32\x16.milvus.grpc.RowRecord\x12-\n\x11query_range_array\x18\x03 \x03(\x0b\x32\x12.milvus.grpc.Range\x12\x0c\n\x04topk\x18\x04 \x01(\x03\"n\n\x18SearchVectorInFilesInfos\x12\x15\n\rfile_id_array\x18\x01 \x03(\t\x12;\n\x13search_vector_infos\x18\x02 \x01(\x0b\x32\x1e.milvus.grpc.SearchVectorInfos\"+\n\x0bQueryResult\x12\n\n\x02id\x18\x01 \x01(\x03\x12\x10\n\x08\x64istance\x18\x02 \x01(\x01\"h\n\x0fTopKQueryResult\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.milvus.Status\x12\x35\n\x13query_result_arrays\x18\x02 \x03(\x0b\x32\x18.milvus.grpc.QueryResult\"C\n\x0bStringReply\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.milvus.Status\x12\x14\n\x0cstring_reply\x18\x02 \x01(\t\"?\n\tBoolReply\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.milvus.Status\x12\x12\n\nbool_reply\x18\x02 \x01(\x08\"H\n\rTableRowCount\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.milvus.Status\x12\x17\n\x0ftable_row_count\x18\x02 \x01(\x03\"\x16\n\x07\x43ommand\x12\x0b\n\x03\x63md\x18\x01 \x01(\t\"<\n\x0cServerStatus\x12\x1e\n\x06status\x18\x01 \x01(\x0b\x32\x0e.milvus.Status\x12\x0c\n\x04info\x18\x02 \x01(\t2\xf7\x05\n\rMilvusService\x12\x39\n\x0b\x43reateTable\x12\x18.milvus.grpc.TableSchema\x1a\x0e.milvus.Status\"\x00\x12<\n\x08HasTable\x12\x16.milvus.grpc.TableName\x1a\x16.milvus.grpc.BoolReply\"\x00\x12\x35\n\tDropTable\x12\x16.milvus.grpc.TableName\x1a\x0e.milvus.Status\"\x00\x12\x36\n\nBuildIndex\x12\x16.milvus.grpc.TableName\x1a\x0e.milvus.Status\"\x00\x12\x42\n\x0cInsertVector\x12\x18.milvus.grpc.InsertInfos\x1a\x16.milvus.grpc.VectorIds\"\x00\x12P\n\x0cSearchVector\x12\x1e.milvus.grpc.SearchVectorInfos\x1a\x1c.milvus.grpc.TopKQueryResult\"\x00\x30\x01\x12^\n\x13SearchVectorInFiles\x12%.milvus.grpc.SearchVectorInFilesInfos\x1a\x1c.milvus.grpc.TopKQueryResult\"\x00\x30\x01\x12\x43\n\rDescribeTable\x12\x16.milvus.grpc.TableName\x1a\x18.milvus.grpc.TableSchema\"\x00\x12H\n\x10GetTableRowCount\x12\x16.milvus.grpc.TableName\x1a\x1a.milvus.grpc.TableRowCount\"\x00\x12>\n\nShowTables\x12\x14.milvus.grpc.Command\x1a\x16.milvus.grpc.TableName\"\x00\x30\x01\x12\x39\n\x04Ping\x12\x14.milvus.grpc.Command\x1a\x19.milvus.grpc.ServerStatus\"\x00\x62\x06proto3')
  ,
...
_INSERTINFOS = _descriptor.Descriptor(
  name='InsertInfos',
  full_name='milvus.grpc.InsertInfos',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='table_name', full_name='milvus.grpc.InsertInfos.table_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='row_record_array', full_name='milvus.grpc.InsertInfos.row_record_array', index=1,
...
_SEARCHVECTORINFOS = _descriptor.Descriptor(
  name='SearchVectorInfos',
  full_name='milvus.grpc.SearchVectorInfos',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='table_name', full_name='milvus.grpc.SearchVectorInfos.table_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='query_record_array', full_name='milvus.grpc.SearchVectorInfos.query_record_array', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='query_range_array', full_name='milvus.grpc.SearchVectorInfos.query_range_array', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='topk', full_name='milvus.grpc.SearchVectorInfos.topk', index=3,
...
_SEARCHVECTORINFILESINFOS = _descriptor.Descriptor(
  name='SearchVectorInFilesInfos',
  full_name='milvus.grpc.SearchVectorInFilesInfos',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='file_id_array', full_name='milvus.grpc.SearchVectorInFilesInfos.file_id_array', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='search_vector_infos', full_name='milvus.grpc.SearchVectorInFilesInfos.search_vector_infos', index=1,
...
_SERVERSTATUS = _descriptor.Descriptor(
  name='ServerStatus',
  full_name='milvus.grpc.ServerStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='milvus.grpc.ServerStatus.status', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='info', full_name='milvus.grpc.ServerStatus.info', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INSERTINFOS.fields_by_name['row_record_array'].message_type = _ROWRECORD
_VECTORIDS.fields_by_name['status'].message_type = status__pb2._STATUS
_SEARCHVECTORINFOS.fields_by_name['query_record_array'].message_type = _ROWRECORD
_SEARCHVECTORINFOS.fields_by_name['query_range_array'].message_type = _RANGE
_SEARCHVECTORINFILESINFOS.fields_by_name['search_vector_infos'].message_type = _SEARCHVECTORINFOS
...
_SERVERSTATUS.fields_by_name['status'].message_type = status__pb2._STATUS
...
DESCRIPTOR.message_types_by_name['InsertInfos'] = _INSERTINFOS
DESCRIPTOR.message_types_by_name['VectorIds'] = _VECTORIDS
DESCRIPTOR.message_types_by_name['SearchVectorInfos'] = _SEARCHVECTORINFOS
DESCRIPTOR.message_types_by_name['SearchVectorInFilesInfos'] = _SEARCHVECTORINFILESINFOS
...
InsertInfos = _reflection.GeneratedProtocolMessageType('InsertInfos', (_message.Message,), {
  'DESCRIPTOR' : _INSERTINFOS,
  '__module__' : 'milvus_pb2'
  # @@protoc_insertion_point(class_scope:milvus.grpc.InsertInfos)
  })
_sym_db.RegisterMessage(InsertInfos)
...
SearchVectorInfos = _reflection.GeneratedProtocolMessageType('SearchVectorInfos', (_message.Message,), {
  'DESCRIPTOR' : _SEARCHVECTORINFOS,
  '__module__' : 'milvus_pb2'
  # @@protoc_insertion_point(class_scope:milvus.grpc.SearchVectorInfos)
  })
_sym_db.RegisterMessage(SearchVectorInfos)

SearchVectorInFilesInfos = _reflection.GeneratedProtocolMessageType('SearchVectorInFilesInfos', (_message.Message,), {
  'DESCRIPTOR' : _SEARCHVECTORINFILESINFOS,
  '__module__' : 'milvus_pb2'
  # @@protoc_insertion_point(class_scope:milvus.grpc.SearchVectorInFilesInfos)
  })
_sym_db.RegisterMessage(SearchVectorInFilesInfos)
...
_MILVUSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='BuildIndex',
    full_name='milvus.grpc.MilvusService.BuildIndex',
    index=3,
    containing_service=None,
    input_type=_TABLENAME,
    output_type=status__pb2._STATUS,
  ...
  _descriptor.MethodDescriptor(
    name='InsertVector',
    full_name='milvus.grpc.MilvusService.InsertVector',
    index=4,
    containing_service=None,
    input_type=_INSERTINFOS,
    output_type=_VECTORIDS,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='SearchVector',
    full_name='milvus.grpc.MilvusService.SearchVector',
    index=5,
    containing_service=None,
    input_type=_SEARCHVECTORINFOS,
    output_type=_TOPKQUERYRESULT,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='SearchVectorInFiles',
    full_name='milvus.grpc.MilvusService.SearchVectorInFiles',
    index=6,
    containing_service=None,
    input_type=_SEARCHVECTORINFILESINFOS,
    output_type=_TOPKQUERYRESULT,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='milvus.grpc.MilvusService.GetTableRowCount',
    index=8,
    containing_service=None,
    input_type=_TABLENAME,
  ...
  _descriptor.MethodDescriptor(
    name='Ping',
    full_name='milvus.grpc.MilvusService.Ping',
    index=10,
    containing_service=None,
    input_type=_COMMAND,
