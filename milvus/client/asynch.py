...
class Future(AbstractFuture):
    def __init__(self, future, done_callback=None, pre_exception=None):
        self._future = future
        self._done_cb = done_callback  # keep compatible (such as Future(future, done_callback))
        self._done_cb_list = []
...
#       Future(future, done_cb, pre_exception) = ChunkedFuture([future], done_cb, pre_exception)
