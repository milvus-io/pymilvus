class AbsMilvus:
    ...
    def insert(self, collection_name, entities, ids=None, partition_tag=None, params=None,
        ...
        :type partition_tag: str or None.
            If partition_tag is None, entities will be inserted to the collection rather than
            partitions.
             ...
             `{
                 "bool": {
                     "must": [
                         ...
                         {"vector": {"Vec": {"topk": 10, "query": vec[: 1],
                                "params": {"index_name": Indextype.IVF_FLAT, "nprobe": 10}}}}
                     ],
                 },
             }`
            OR
    ...
    def search_in_segment(self,
                          collection_name, segment_ids, query_entities, params=None, timeout=None):
        """
        :param collection_name:
        :type  collection_name: str
