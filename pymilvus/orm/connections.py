...
class Connections(metaclass=SingleInstanceMetaClass):
    ...
    def connect(
        ...
        **kwargs,
        ...
        :param alias: The name of milvus connection. If not provided, it will be generated by the uri and user. For each alias, 
        there will be one and only one connection created. 
        :type  alias: str
