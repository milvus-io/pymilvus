    ...
    def __pack(self, raw: Any):
        ...
        for type_param in raw.type_params:
            if type_param.key == "params":
                ...
                if type_param.key in ["max_capacity"] and raw.data_type in (DataType.ARRAY, DataType.ARRAY_OF_VECTOR):
                    self.params[type_param.key] = int(type_param.value)
...
class CollectionSchema:
    ...
    def __pack(self, raw: Any):
        ...
        self.struct_array_fields = [StructArrayFieldSchema(f) for f in raw.schema.struct_array_fields]
