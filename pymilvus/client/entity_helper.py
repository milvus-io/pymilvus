...
def get_array_length(array_item: Any) -> int:
    ...
    elif hasattr(array_item, 'int_data') and array_item.int_data:
        return len(array_item.int_data.data)
    elif hasattr(array_item, 'long_data') and array_item.long_data:
        return len(array_item.long_data.data)
    elif hasattr(array_item, 'float_data') and array_item.float_data:
        return len(array_item.float_data.data)
    elif hasattr(array_item, 'double_data') and array_item.double_data:
        return len(array_item.double_data.data)
    elif hasattr(array_item, 'bool_data') and array_item.bool_data:
...
def get_array_value_at_index(array_item: Any, idx: int) -> Any:
    ...
    if hasattr(array_item, 'string_data') and array_item.string_data and idx < len(array_item.string_data.data):
        return array_item.string_data.data[idx]
    elif hasattr(array_item, 'int_data') and array_item.int_data and idx < len(array_item.int_data.data):
        return array_item.int_data.data[idx]
    elif hasattr(array_item, 'long_data') and array_item.long_data and idx < len(array_item.long_data.data):
        return array_item.long_data.data[idx]
    elif hasattr(array_item, 'float_data') and array_item.float_data and idx < len(array_item.float_data.data):
        return array_item.float_data.data[idx]
    elif hasattr(array_item, 'double_data') and array_item.double_data and idx < len(array_item.double_data.data):
        return array_item.double_data.data[idx]
    elif hasattr(array_item, 'bool_data') and array_item.bool_data and idx < len(array_item.bool_data.data):
    ...
    for sub_field in struct_arrays.fields:
        if sub_field.type == DataType.ARRAY:
            ...
            if hasattr(sub_field, 'vectors') and hasattr(sub_field.vectors, 'vector_array'):
                if row_idx < len(sub_field.vectors.vector_array.data):
