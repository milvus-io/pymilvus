...
TYPE_VALIDATOR = {
    ...
    DataType.INT8.name: lambda x: isinstance(x, int) and not isinstance(x, bool) and -128 <= x <= 127,
    DataType.INT16.name: lambda x: isinstance(x, int) and not isinstance(x, bool) and -32768 <= x <= 32767,
    DataType.INT32.name: lambda x: isinstance(x, int) and not isinstance(x, bool) and -2147483648 <= x <= 2147483647,
