...
class FieldSchema(_message.Message):
    __slots__ = ["autoID", "data_type", "description", "element_type", "fieldID", "index_params", "is_primary_key", "name", "state", "type_params"]
    AUTOID_FIELD_NUMBER: _ClassVar[int]
