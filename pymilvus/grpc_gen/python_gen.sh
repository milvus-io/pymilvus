...
python3 -m grpc_tools.protoc -I ./milvus-proto/proto --python_out=${OUTDIR} common.proto
python3 -m grpc_tools.protoc -I ./milvus-proto/proto --python_out=${OUTDIR} schema.proto
python3 -m grpc_tools.protoc -I ./milvus-proto/proto --python_out=${OUTDIR} --grpc_python_out=${OUTDIR} milvus.proto
