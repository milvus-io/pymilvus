...
class AsyncMilvusClient:
    ...
    async def create_collection(
        ...
        **kwargs,
        ...
        if schema is None:
            await self._fast_create_collection(
                collection_name,
                dimension,
        ...
        await self._create_collection_with_schema(
    ...
    async def list_indexes(
        self, collection_name: str, field_name: Optional[str] = "", **kwargs
    ) -> List[str]:
        conn = self._get_connection()
    ...
    async def drop_database_properties(
        self, db_name: str, property_keys: List[str], **kwargs
    ) -> None:
        conn = self._get_connection()
    ...
    async def drop_user(self, user_name: str, timeout: Optional[float] = None, **kwargs) -> None:
        conn = self._get_connection()
    ...
    async def list_roles(self, timeout: Optional[float] = None, **kwargs) -> List[str]:
        conn = self._get_connection()
    ...
    async def flush(self, collection_name: str, timeout: Optional[float] = None, **kwargs) -> None:
        conn = self._get_connection()
